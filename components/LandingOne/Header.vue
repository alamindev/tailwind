 <template>
    <header class="dark:bg-brand-dark">
    <div class="relative container mx-auto">
      <div class="flex justify-between items-center   mx-auto px-4 py-3 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
        <div class="flex justify-start items-center ">
          ...
          <nav :class="isOpen ? '!right-0' : ''" ref="el" class="ml-10 lg:static fixed bottom-0 dark:bg-brand-dark lg:dark:bg-transparent bg-white lg:bg-transparent h-full w-72 lg:w-auto z-40 right-[-999px] transition-all duration-300 top-0 p-4 lg:p-0">  
           <ul class="flex flex-col lg:flex-row gap-4 lg:gap-8 pt-28 lg:pt-0">
             <li>
               <nuxt-link to="/landing-one" class="text-base font-medium dark:text-neutral-200 text-gray-500 hover:text-gray-900">Home</nuxt-link> 
             </li>
             <li> 
                 <nuxt-link to="/landing-one/services" class="text-base font-medium dark:text-neutral-200 text-gray-500 hover:text-gray-900">Services</nuxt-link> 
             </li>
             <li> 
                <nuxt-link to="/landing-one/blogs" class="text-base font-medium dark:text-neutral-200 text-gray-500 hover:text-gray-900">Blogs</nuxt-link> 
             </li>
             <li>
                <nuxt-link to="/landing-one/pricing" class="text-base font-medium dark:text-neutral-200 text-gray-500 hover:text-gray-900">Pricing</nuxt-link>  
             </li>
             <li> 
                 <nuxt-link to="/landing-one/about-us" class="text-base font-medium dark:text-neutral-200 text-gray-500 hover:text-gray-900">About us</nuxt-link>  
             </li>
             <li>
                 <nuxt-link to="/landing-one/contact-us" class="text-base font-medium dark:text-neutral-200 text-gray-500 hover:text-gray-900">Contact us</nuxt-link>   
             </li>
           </ul>
           <button @click="closeMenu" class="focus:outline-none lg:hidden p-1 absolute top-5 left-4 dark:bg-gray-700 bg-neutral-50 border dark:border-gray-600 border-neutral-100" type="button">
             <svg class="h-6 w-6 text-neutral-500 dark:text-neutral-200" x-description="Heroicon name: outline/x" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
              </svg>
           </button>
            <div class="lg:hidden flex gap-2 items-center pt-10">
                <a href="#" class="w-full  text-center whitespace-nowrap text-base font-medium dark:text-neutral-200 text-gray-500 hover:text-gray-900"> Sign in </a>
                <a href="#" class="w-full  text-center ml-8 whitespace-nowrap inline-flex items-center justify-center bg-brand-red  px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white"> Sign up </a>
            </div>
          </nav> 
        </div> 
        <div class=" flex items-center justify-end md:flex-1 lg:w-0"> 
          <button type="button"  aria-label="Color Mode"  class="focus:outline-none mr-2 lg:mr-6" >
            <svg  @click="ToggleMode('light')" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-neutral-200" v-if="mode === 'dark'" >
